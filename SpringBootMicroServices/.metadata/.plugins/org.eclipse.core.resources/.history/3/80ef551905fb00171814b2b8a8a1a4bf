 ...
 * @author  Jagan Reddy
 * 
 * Vehicle Spring Boot Application
 */
...
public class VehicleApplication {
	 ...
	 * Ex: if you send email(abc@gmail.com) on path to consume service(in our case getCustomerInfoByEmail).Spring ignores things after last dot(.) by treating that as extension.
