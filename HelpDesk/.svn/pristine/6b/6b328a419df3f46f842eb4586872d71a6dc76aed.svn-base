...
<nav class="navbar">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
        <li><a class ="signUp" href="signUp" ><span class="glyphicon glyphicon-user"></span> Sign Up</a></li>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <img src="http://www.datagrafservizi.it/wp-content/uploads/2015/03/helpdesk.png"  style="width:1400px; height:450px">
      </div>

      <div class="item">
        <img src="https://blog.freshdesk.com/wp-content/uploads/2017/06/Blog_Helpdesk-Whitepaper.jpg"  style="width:1400px; height:450px">
      </div>
    </div>
